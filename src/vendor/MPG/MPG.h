...
class MPG
{
	public:
		 ...
		 */
		inline void debounce() { debouncer.debounce(&state); }
		 ...
		 */
		inline bool pressedButton(const uint16_t mask) { return (state.buttons & mask) == mask; }

		/**
		 * @brief Check for a dpad press. Used by `pressed[Dpad]` helper methods.
		 */
		inline bool pressedDpad(const uint8_t mask) { return (state.dpad & mask) == mask; }

		inline bool pressedUp()    { return pressedDpad(GAMEPAD_MASK_UP); }
		inline bool pressedDown()  { return pressedDpad(GAMEPAD_MASK_DOWN); }
		inline bool pressedLeft()  { return pressedDpad(GAMEPAD_MASK_LEFT); }
		inline bool pressedRight() { return pressedDpad(GAMEPAD_MASK_RIGHT); }
		inline bool pressedB1()    { return pressedButton(GAMEPAD_MASK_B1); }
		inline bool pressedB2()    { return pressedButton(GAMEPAD_MASK_B2); }
		inline bool pressedB3()    { return pressedButton(GAMEPAD_MASK_B3); }
		inline bool pressedB4()    { return pressedButton(GAMEPAD_MASK_B4); }
		inline bool pressedL1()    { return pressedButton(GAMEPAD_MASK_L1); }
		inline bool pressedR1()    { return pressedButton(GAMEPAD_MASK_R1); }
		inline bool pressedL2()    { return pressedButton(GAMEPAD_MASK_L2); }
		inline bool pressedR2()    { return pressedButton(GAMEPAD_MASK_R2); }
		inline bool pressedS1()    { return pressedButton(GAMEPAD_MASK_S1); }
		inline bool pressedS2()    { return pressedButton(GAMEPAD_MASK_S2); }
		inline bool pressedL3()    { return pressedButton(GAMEPAD_MASK_L3); }
		inline bool pressedR3()    { return pressedButton(GAMEPAD_MASK_R3); }
		inline bool pressedA1()    { return pressedButton(GAMEPAD_MASK_A1); }
		inline bool pressedA2()    { return pressedButton(GAMEPAD_MASK_A2); }
		inline bool pressedF1()    { return pressedButton(f1Mask); }
		inline bool pressedF2()    { return pressedButton(f2Mask); }
